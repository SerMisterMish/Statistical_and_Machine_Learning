...
\par\smallskip
\begin{figure}[h!]
  \includegraphics[width=0.4 \textwidth]{detree}
...
\begin{frame}{Решающие деревья в задаче регрессии}
\begin{figure}[h!]
  \includegraphics[width=1 \textwidth]{retree}
...
\begin{frame}{Решающие деревья в задаче классификации}
\begin{figure}[h!]
  \includegraphics[width=1 \textwidth]{cltree1}
...
\begin{frame}{Решающие деревья в задаче классификации}
\begin{figure}[h!]
  \includegraphics[width=0.9 \textwidth]{cltree2}
...
\begin{figure}[h!]
  \includegraphics[width=1 \textwidth]{bagging_re}
...
\begin{figure}[h!]
  \includegraphics[width=1 \textwidth]{bagging_cl}
...
\begin{figure}[h!]
  \includegraphics[width=0.8 \textwidth]{rf_re}
...
\begin{figure}[h!]
  \includegraphics[width=1 \textwidth]{rf_cl}
 \caption{Граница сглаженная и практически нет признаков переобучения}
\end{figure}
\end{frame}
